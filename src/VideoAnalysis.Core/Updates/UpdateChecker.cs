...
using VideoAnalysis.Core.Updates.Models;

namespace VideoAnalysis.Core.Updates;
...
public sealed class UpdateChecker : IDisposable
{
    ...
    public UpdateChecker(HttpClient? httpClient = null)
    {
        ...
        _http.DefaultRequestHeaders.UserAgent.ParseAdd("VideoAnalysisLab-UpdateChecker");
